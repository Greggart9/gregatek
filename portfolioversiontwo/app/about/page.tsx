  ...
  return (
    <div className="relative m-3 sm:m-6 text-white">
      <div className="relative h-[calc(100vh-48px)] ">
       ...
       {/* SECOND */}
       <TextReveal>
      <div className=" flex justify-center bg-amber-800 items-center w-full h-fit pt-15.5 sm:pt-21.5 pb-10 md:pt-31.5 md:pb-25 text-2xl md:text-[40px] xl:text-5xl">
      <div className="flex justify-center w-full items-center bg-amber-200">
